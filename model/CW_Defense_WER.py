...
# Set attack path 
data_wav_dire = '/data/RandomAudios1'
data_txt_dire = '/data/RandomTxts1'
adv_wav_dire = '/data/Adv_Wav1'
adv_txt_dire = '/data/Adv_Txt1'
...
T          = 10      # the endtime of processing. 
...
for n in range(0, num_loop):
    ...
    # Load adv audio for C&W Attack
    new_attacked_name = 'adv1_'+ str(n)
    adv_load = np.load(r'/data/home/wentao/adversarial-robustness-toolbox/taotest/Adv_Wav1/'+new_attacked_name+'.npy')
    # Handle Nan value
    ...
    newout = [1e-1*npout[0] - 1e-1*npout[1]]
