...
# List to ndarray
print("After {num} epochs, the final result shows as follows ".format(num = num_loop))
...
print('The max wer value between adversarial example and adversarial target is ',at_wer_max)
...
print('The max wer value between adversarial example and original context is ',ao_wer_max)
